...
namespace JWBControl
{
    ...
    {
        //控件层
        private FrameForm Main;
        //带参构造
        public SkinForm(FrameForm main)
        {
            //将控制层传值过来
            this.Main = main;
            InitializeComponent();
        ...
        public void SetBits()
        {
            ...
            ImageDrawRect.DrawRect(g, global::AutoUpdate.Resource1.main_light_bkg_top123, ClientRectangle, Rectangle.FromLTRB(_BacklightLTRB.X, _BacklightLTRB.Y, _BacklightLTRB.Width, _BacklightLTRB.Height), 1, 1);
